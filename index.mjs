// Banco de Moçambique exchange rates via the AllRatesToday API.
const BASE = 'https://allratestoday.com/api/v1/central-bank/bdm';
...
/** Latest rate for one pair, e.g. getRate('USD', 'MZN', { apiKey }). */
